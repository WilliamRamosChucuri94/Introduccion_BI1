...
### 1.2. Evolución de Business Intelligence

![](images/clipboard-1576259561.png){width="539"}

### 1.3. Rol del dato en las organizaciones
...
### 2.5. El caso: Cartera de créditos
...
## 4. Unidad 4-Visualización Estratégica

### 4.1. Principios de Visualización Estratégica

**¿Qué es la visualización de datos?**

La visualización de datos es la representación gráfica de información
con el propósito de facilitar la identificación de patrones, tendencias,
diferencias, relaciones y valores atípicos.

![](images/clipboard-3918026172.png)

-   Una visualización efectiva no busca únicamente presentar datos de
    forma atractiva.

-   Su objetivo principal es facilitar la comprensión y apoyar la toma
    de decisiones.

Podemos decir que:

**"Una buena visualización reduce el esfuerzo necesario para comprender
los datos."**

![](images/clipboard-3215311142.png)

-   **Dato:** valor sin contexto.

-   **Información:** dato organizado y contextualizado.

-   **Análisis:** comparación e identificación de patrones.

-   **Conocimiento:** interpretación de los resultados.

-   **Decisión:** acción basada en la evidencia disponible.

**Ejemplo:**

![](images/clipboard-1690003179.png)

### **¿Qué debemos hacer?**

1.  Definir primero la pregunta

    ¿Qué queremos comunicar?

    **Pregunta ↓ Indicador ↓ Comparación necesaria ↓ Visualización**

2.  Elegir el gráfico según el objetivo

    | Pregunta | Visualización recomendada |
    |------------------------------------|------------------------------------|
    | ¿Cuál es mayor? | Barras |
    | ¿Cómo ha cambiado en el tiempo? | Línea |
    | ¿Cómo se distribuye un total? | Barras apiladas / pastel en casos simples |
    | ¿Cuál es el valor actual? | Tarjeta |
    | ¿Cómo se distribuyen los datos? | Histograma |
    | ¿Existe relación entre dos variables? | Dispersión |
    | ¿Necesito consultar valores individuales? | Tabla / matriz |
...
3.  Simplicidad
    ...
    Pueden competir con la información.

    -   Una visualización debería contener únicamente elementos que
        contribuyan a interpretar los datos.

    -   Menos elementos no significa menos información. Significa menos
        distracciones.

4.  Jerarquía Visual

    No todos los elementos de un dashboard tienen la misma importancia.

    El usuario debería identificar rápidamente:

    1.  Indicadores principales

    2.  Comparaciones relevantes
...
5.  Uso del color
    ...
    El color puede utilizarse para:
    ...
    Pero no debería utilizarse únicamente como decoración.

    **Ejemplos:**

    **Rojo:** alerta o deterioro.

    **Verde:** cumplimiento o resultado favorable.

    **Gris:** contexto.

6.  Contexto

Un número por sí mismo suele ser poco informativo.
...
> **684,6 puntos — promedio global ponderado**

Mejor todavía si existe referencia:

> **684,6 puntos — promedio global ponderado de estudiantes evaluados**

### 4.2. Storytelling con datos

**¿Qué es storytelling con datos?**

No significa contar una historia literaria.

Significa:

**"Organizar evidencia de manera que conduzca al usuario desde una
pregunta hasta una interpretación."**

### 4.3. KPIs

**¿Qué es una métrica?**

Una métrica es una medida cuantitativa utilizada para describir alguna
...
Un Key Performance Indicator es una métrica seleccionada por su
relevancia para evaluar el desempeño respecto a un objetivo.
...
97,2 % de estudiantes evaluados.

Porque este segundo indicador proporciona información directamente
interpretable sobre cobertura.

### Características de un buen KPI

1.  Relevante: Relacionado con un objetivo.

2.  Comprensible: Fácil de interpretar.

3.  Medible: Construido con datos disponibles.

4.  Comparable: Permitir comparación temporal, territorial o frente a
    una meta.

5.  Accionable: Aportar información útil para una decisión.

### 4.4. Dashboards

-   Un dashboard no es una colección de gráficos.

-   Un buen dashboard debe responder preguntas.

**¿Qué es un Dashboard?**

*"Un dashboard es una interfaz visual que integra indicadores y
visualizaciones relevantes para facilitar el seguimiento, análisis e
interpretación de información."*

### Tipos de Dashboard

| Tipo de Dashboard | Público Objetivo | Densidad de Indicadores | Enfoque y Monitoreo |
|------------------|------------------|--------------------|------------------|
| 🎯 **Estratégico** | Alta dirección | Pocos indicadores | Seguimiento de objetivos macro y visión global del negocio. |
| ⚙️ **Táctico** | Responsables de áreas | Mayor nivel de detalle | Análisis de rendimiento por departamento y apoyo a planes de acción. |
| 📋 **Operativo** | Líderes de equipo y personal operativo | Métricas muy específicas | Monitoreo frecuente e información actualizada en tiempo real para la gestión diaria. |

### Niveles de Analítica

Un dashboard de Power BI normalmente se mueve principalmente entre:

**Descriptiva** y **Diagnóstica exploratoria**.

Es importante mencionar que ...

***Dashboard ≠ causalidad***

Vamos a ver estos puntajes: ...
...
Si tenemos este cuadro dentro del PI, podriamos decir que existen
diferencias entre los tipos de sostenimiento.

Pero no permite afirmar automáticamente que: El sostenimiento particular
causa mejores resultados.

Porque podrían existir variables como:
...
## 5. Unidad 5-Requerimientos de Negocio

### 5.1 Design Thinking para proyectos de Business Intelligence

*"Un dashboard no empieza en Power BI. Empieza entendiendo un problema
del negocio."*
...
-   Modelar y Diseñar solución

-   Validar con el usuario

![](images/clipboard-1561239764.png)

#### Estudio de Caso

El Instituto Nacional de Evaluación Educativa (INEVAL) aplica
evaluaciones estandarizadas para medir el desempeño académico de los
estudiantes ecuatorianos.

Las autoridades educativas requieren una herramienta analítica que
permita monitorear los resultados obtenidos por los estudiantes,
identificar brechas de desempeño y apoyar la toma de decisiones en
materia de política educativa.

Actualmente existe una gran cantidad de información, pero se requiere
transformarla en indicadores y visualizaciones que faciliten el análisis
...
El Ministerio de Educación desea responder preguntas como:\<

-   ¿Cuál es el puntaje promedio nacional?

-   ¿Qué provincias presentan mejores resultados?

-   ¿Existen diferencias entre zonas geográficas?

-   ¿Qué grupos requieren atención prioritaria?
...
| Actor                 | Necesidad                   |
|-----------------------|-----------------------------|
| Ministro de Educación | Panorama nacional           |
| Director Distrital    | Resultados de su territorio |
| Rector                | Desempeño de su institución |
| Analista              | Elaboración de reportes     |

### Resultado esperado

Necesidad de negocio:

> Monitorear el desempeño académico de los estudiantes ecuatorianos
> mediante indicadores que permitan identificar oportunidades de mejora.
...
> Conocer el rendimiento académico de los estudiantes.

### Requerimientos funcionales

RF01

> El sistema debe visualizar el puntaje promedio nacional.

RF02

> El sistema debe mostrar resultados por provincia.

RF03

> El sistema debe permitir filtrar por sexo.

RF04

> El sistema debe permitir filtrar por régimen educativo.

RF05

> El sistema debe mostrar comparaciones entre grupos.

RF06

> El sistema debe visualizar la distribución de puntajes.

### Requerimientos no funcionales

RNF01

> La información debe presentarse mediante dashboard interactivo.

RNF02

> Los resultados deben actualizarse cuando existan nuevas evaluaciones.

RNF03

> Las visualizaciones deben ser de fácil interpretación.
...
> Como autoridad educativa quiero visualizar el puntaje promedio
> nacional para conocer el nivel general de desempeño estudiantil.

### Historia 2

> Como director distrital quiero comparar los resultados de mi provincia
> con el promedio nacional para identificar brechas educativas.

### Historia 3

> Como analista de información quiero filtrar resultados por
> características demográficas para realizar estudios específicos.

### Métricas

KPI Framework + SMART

KPI 1- Puntaje Promedio -Promedio(Puntaje)

KPI 2-Puntaje Máximo

KPI 3- Puntaje Mínimo

KPI 4- Porcentaje de estudiantes con desempeño satisfactorio

KPI 5- Brecha provincial- Puntaje provincia - Puntaje Nacional

KPI 6- Número de estudiantes evaluados

### Modelo Conceptual de Información

Antes de construir un dashboard es necesario identificar las principales
entidades del negocio y comprender cómo se relacionan entre sí.

En el caso de INEVAL, la información requerida para analizar el
desempeño estudiantil puede organizarse mediante los siguientes
elementos:
...
-   Provincia: ubicación geográfica del estudiante.

-   Institución educativa: establecimiento donde estudia.

-   Estudiante: persona evaluada.

-   Evaluación: prueba aplicada por INEVAL.

-   Resultado: puntaje obtenido por el estudiante.

Este modelo permite identificar qué información será necesaria para
construir indicadores y visualizaciones posteriores.

| Entidad     | Variables principales |
|-------------|-----------------------|
| Provincia   | Provincia             |
| Institución | Nombre Institución    |
| Estudiante  | ID Estudiante, Sexo   |
| Resultado   | Puntaje               |
| Evaluación  | Período               |
...
-   [**Reporting y Machine
    Learning**](https://williamramoschucuri94.github.io/Curso_ML_Final/)

-   [**Series
    Temporales**](https://williamramoschucuri94.github.io/Series-de-Tiempo/)

-   [**Modelos
    Estructurales**](https://williamramoschucuri94.github.io/Modelos-Estructurales/)

Linkedin

[William
Ramos-Chucuri](www.linkedin.com/in/william-ramos-chucuri-80131885)
